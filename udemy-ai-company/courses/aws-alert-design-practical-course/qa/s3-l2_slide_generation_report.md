...
- Lecture: `s3-l2`
- Title: Missing dataとComposite Alarmの使いどころ
...
- Prompt plan: `slides/s3-l2_gpt_image2_prompts.md`
- GPT-Image2 source directory: `slides/s3-gpt-image2-sources/s3-l2/`
- Final PNG directory: `slides/s3-l2-final/`
- Build slide directory: `slides/s3-l2/`

## Generated Slides

- Slide count: 7
- Final size: 1920x1080
- Contact sheet: `qa/s3-l2_contact_sheet.png`
...
- `slides/s3-l2/` mirrors the final PNGs for the video build tool.
