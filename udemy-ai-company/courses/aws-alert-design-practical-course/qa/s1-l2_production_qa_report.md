...
- GPT-Image2 prompt file: `slides/s1-l2_gpt_image2_prompts.md`
- AWS source verification: `qa/aws_source_verification_report.md`
- Video build report: `video/s1-l2/build_report.json`
...
- VOICEVOX generation: ok, 7 WAV files, 353.387 sec total
- MP4 decode check: ok
- MP4 faststart: true
