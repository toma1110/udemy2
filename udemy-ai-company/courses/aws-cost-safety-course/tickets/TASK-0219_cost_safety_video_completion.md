...
Task ID: `TASK-0219`
Title: Cost Safetyコースの全レクチャー動画を作成しUdemy成立尺へ是正する
GitHub Issue: #193
...
- final scripts, GPT-Image2 slides, VOICEVOX audio, and MP4s after CEO approval
...
- billing alarm, budget, cleanup, and cost safety guidance remains accurate
...
Notes:
- Current audit: 12 spec lectures, 0 lecture MP4s, 0 minutes total. Promo video exists but does not count toward lecture video requirements.
