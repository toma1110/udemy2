...
Task ID: `TASK-0209`
Title: Lambdaのエラー率を監視するコースをUdemy成立コースとして最後まで動画生成する
GitHub Issue: #182
...
Production Order: 3 of 5

## Inputs

Input Files:
- `udemy-ai-company/courses/aws-lambda-error-rate-monitoring-course/course_spec.md`
- `udemy-ai-company/courses/aws-lambda-error-rate-monitoring-course/handson/lambda_error_rate_handson_plan.md`
- `udemy-ai-company/courses/aws-lambda-error-rate-monitoring-course/handson/error_rate_formula_and_thresholds.md`
- `udemy-ai-company/courses/aws-lambda-error-rate-monitoring-course/scripts/s1-l1_script_plan.md`
- `udemy-ai-company/courses/aws-lambda-error-rate-monitoring-course/slides/s1-l1_gpt_image2_prompts.md`
- `udemy-ai-company/courses/aws-lambda-error-rate-monitoring-course/video/s1-l1_video_spec.md`
...
Dependencies:
- `TASK-0193` course/video spec completed
- `TASK-0208` full course video generation and production QA completed
...
- 全レクチャーの完成台本が `course_spec.md` とエラー率計算資料に整合している
- 全レクチャーのMP4が生成されている
- `Errors / Invocations * 100`、低トラフィック注意、連続評価期間の説明が正確
- 実AWS/Lambda/SNS/CloudWatch Alarm/CloudFormation操作を行っていない
