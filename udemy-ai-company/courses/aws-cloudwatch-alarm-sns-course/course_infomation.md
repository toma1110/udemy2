...
■ 講座尺・動画生成結果
本コースは6レクチャー構成で、2026-05-17に講義本編のMP4を再生成しました。合計動画尺は2115.726秒、35.26分です。

Google Driveレビュー用アップロードは2026-05-17に完了しています。Drive URLは `qa/course_drive_upload_report.md` に記録しています。
