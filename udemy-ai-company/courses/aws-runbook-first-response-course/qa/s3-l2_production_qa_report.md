...
- GPT-Image2 prompt file: `slides/s3-l2_gpt_image2_prompts.md`
- AWS source verification: `qa/aws_source_verification_report.md`
- Video build report: `video/s3-l2/build_report.json`
...
- VOICEVOX generation: ok, 9 WAV files, 358.805 sec total
- MP4 decode check: ok
- MP4 faststart: true
