...
- Script: `scripts/s1-l1_runbook_map_script.md`
- GPT-Image2 prompt file: `slides/s1-l1_gpt_image2_prompts.md`
- AWS source verification: `qa/aws_source_verification_report.md`
- Video build report: `video/s1-l1/build_report.json`
...
- VOICEVOX generation: ok, 8 WAV files, 258.453 sec total
- MP4 decode check: ok
- MP4 faststart: true
