# Task Summary
Task ID: TASK-0070
Title: aws-slo-adoption-course Section 3 Lecture 5 の台本を作成する
...
- udemy-ai-company/courses/aws-slo-adoption-course/qa/s3-l5_script_review_report.md

# Quality Gate
Definition of Done:
- `lectures.md` の Section 3 Lecture 5「CPU使用率をSLIにしない理由」に沿っている
