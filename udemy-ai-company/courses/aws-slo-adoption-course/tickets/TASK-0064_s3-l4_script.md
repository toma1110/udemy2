# Task Summary
Task ID: TASK-0064
Title: aws-slo-adoption-course Section 3 Lecture 4 の台本を作成する
...
- udemy-ai-company/courses/aws-slo-adoption-course/qa/s3-l4_script_review_report.md

# Quality Gate
Definition of Done:
- `lectures.md` の Section 3 Lecture 4「AWSサービス別SLI選定ガイド」に沿っている
