# Task Summary
Task ID: TASK-0026
Title: aws-slo-adoption-course Section 2 Lecture 1 のGPT-Image2スライドを生成する
...
- udemy-ai-company/courses/aws-slo-adoption-course/qa/s2-l1_slide_generation_report.md

# Quality Gate
Definition of Done:
- GPT-Image2でPNG生成されている
- スライド枚数が台本と一致している
- スライド内容が `s2-l1_script.md` と一致している
- SLI、SLO、SLAの関係図がスライドPNG内に含まれている
- Section 1と視覚トーンが大きくずれていない
