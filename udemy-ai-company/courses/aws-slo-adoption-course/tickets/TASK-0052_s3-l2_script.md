# Task Summary
Task ID: TASK-0052
Title: aws-slo-adoption-course Section 3 Lecture 2 の台本を作成する
...
- udemy-ai-company/courses/aws-slo-adoption-course/qa/s3-l2_script_review_report.md

# Quality Gate
Definition of Done:
- `lectures.md` の Section 3 Lecture 2「可用性、レイテンシ、エラー率を設計する」に沿っている
