# Task Summary
Task ID: TASK-0058
Title: aws-slo-adoption-course Section 3 Lecture 3 の台本を作成する
...
- udemy-ai-company/courses/aws-slo-adoption-course/qa/s3-l3_script_review_report.md

# Quality Gate
Definition of Done:
- `lectures.md` の Section 3 Lecture 3「p95/p99を使う理由」に沿っている
