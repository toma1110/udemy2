...
- Slides: `courses/aws-slo-adoption-course/slides/s1-l1/slide_*.png`
- Audio: `courses/aws-slo-adoption-course/audio/s1-l1/slide_*.wav`
- Output: `courses/aws-slo-adoption-course/video/s1-l1/s1-l1.mp4`
...
- 公開前にGoogle Driveアップロード用の最終ファイル名を確定すること
